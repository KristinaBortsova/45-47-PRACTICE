...
export default function CheckoutPage() {
    ...
    return (
       ...
       <div className="border-t border-pink-200 mt-3 pt-3 flex justify-between font-bold text-lg">
          <span> Итого:</span>
          <span className="text-rose-700">{totalAmount} ₽</span>
        </div>
    ...
    >
       <div className="text-center py-4">
            ...
            <p className="text-stone-500 mb-6">
              Ваш заказ на сумму <span className="font-bold text-rose-600">{totalAmount} ₽</span> принят.
              Мы свяжемся с вами по телефону <span className="font-medium text-rose-600">{phone}</span>.
            </p>
            <Button onClick={handleCloseModal} className="w-full bg-rose-500 hover:bg-rose-600">
             На главную
            </Button>
        </div>
    </Modal>
